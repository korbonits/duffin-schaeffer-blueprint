...
\begin{proof}
  ...
  The matching lower bound --- the intervals are pairwise disjoint, so this is an
  equality --- is stated as \texttt{volume\_setAq} and left open, since only the upper
  bound is used.
\end{proof}
