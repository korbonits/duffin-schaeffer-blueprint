...
\begin{lemma}[The iterative propositions]
  \label{lem:gcd-operations}
  \notready
  \uses{def:quality, def:gcdsubgraph}
  \textbf{TRANSCRIBE} --- paper \S8 reduces Proposition 7.1 to three iterative
  propositions (8.1, 8.2, 8.3), proved in \S\S12--14, with supporting lemmas 8.4 and 8.5
  proved in \S\S9--10 and preparatory material in \S11.
\end{lemma}

\begin{theorem}[Existence of a good GCD subgraph]
  \label{thm:gcd-iteration}
  \notready
  \uses{def:quality, def:gcdsubgraph, def:section5}
